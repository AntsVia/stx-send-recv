...
FileTransferClient::FileTransferClient(boost::asio::io_context& io_context,
...
void FileTransferClient::DoConnect(const TcpSocket::resolver::results_type& endpoints) {
